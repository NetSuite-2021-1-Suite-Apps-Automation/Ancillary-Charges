...
public class TestBase {
	...
	public TestBase()
	{
		...
		{
			prop=new Properties();
			FileInputStream fis=new FileInputStream("E:\\Old\\AncillaryCharges_TDP_RP\\src\\main\\java\\com\\qa\\config\\config.properties");
			prop.load(fis);
		}
		catch(IOException e)
		{
	...
	public static void initilizaton()
	{
		...
		if(browserName.equals("chrome")){
			System.setProperty("webdriver.chrome.driver", "C:\\SELENIUM LEARNING\\Chromedriver.exe");
